...
@section('title', 'Inscription Livreur')
...
@section('content')
    <div class="container mt-5">
        <h1 class="text-center mb-4">Inscription Livreur</h1>
        ...
        <form action="{{ route('register') }}" method="POST" class="form-register">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Saisissez le nom légal de votre entreprise.</small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Le numéro SIRET doit comporter exactement 14 chiffres.</small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="taille" id="taille" class="form-control" required>
                        ...
                        <option value="PME">PME (Petites et Moyennes Entreprises)</option>
                        <option value="ETI">ETI (Entreprises de Taille Intermédiaire)</option>
                        <option value="GE">GE (Grandes Entreprises)</option>
                    </select>
                    <small class="form-text text-muted">Sélectionnez la catégorie correspondant à la taille de votre
                        entreprise.</small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="adresseEntreprise" id="adresseEntreprise" class="form-control" required
                        maxlength="100" placeholder="Adresse complète de l'entreprise">
                    <small class="form-text text-muted">Indiquez l'adresse officielle de votre entreprise.</small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Saisissez la ville où se situe votre entreprise.</small>
                </div>
